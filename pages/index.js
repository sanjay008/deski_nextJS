					...
					<div className="row align-items-start justify-content-between">
						<div className="col-lg-6 order-lg-last">
							<div className="illustration-holder">
								<img src={ headerTop.side_img } alt="" className="illustration_01" />
								<img src="images/assets/ils-01.1.png" alt="" className="shapes shape-one" />
								<img src="images/assets/ils-01.2.png" alt="" className="shapes shape-two" />
								<img src="images/assets/ils-01.3.png" alt="" className="shapes shape-three" />
							</div>
						</div>
