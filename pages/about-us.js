			...
			<div className="fancy-hero-two">
				<div className="bg-wrapper">
					<div className="container">
						...
						<div className="row">
						{header_top_content.map(headerContent => {
							return(
				...
				<div className="container">
					<div className="row align-items-center justify-content-between mb-80 md-mb-10">
						...
						<div className="col-lg-4 d-lg-flex justify-content-end">
							<a href="team-V1.html" className="theme-btn-three md-mt-20">See All Members</a>
						</div>
					</div>
...
export async function getStaticProps() {
	const header_top_content = await fetch('http://127.0.0.1:8000/api/getContent/about/1').then(res => res.json());
	const story_section = await fetch('http://127.0.0.1:8000/api/getContent/about/2').then(res => res.json());
	const founder_section = await fetch('http://127.0.0.1:8000/api/getContent/about/3').then(res => res.json());
	return {
		props: {
			header_top_content,
			story_section,
